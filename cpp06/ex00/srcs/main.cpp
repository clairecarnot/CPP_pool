...
int	main(void)
{
	...
	std::cout << LBLUE "Test max float \"340282346638528859811704183484516925440.0f\"" RESET << std::endl;
	ScalarConverter::convert("340282346638528859811704183484516925440.0f");

	std::cout << LBLUE "Test > maxfloat \"340282346638528859811704183484516925441.0\"" RESET << std::endl;
	ScalarConverter::convert("340282346638528859811704183484516925441.0");
